...
AI 기반 개발 프로세스 도입과 프론트엔드 아키텍처 설계에 참여했다. AGENTS.md, phase rules, prompt templates, review checklist를 통해 AI Agent가 참고할 기준을 만들고, 사용자 승인 지점과 공개 경계를 명확히 하는 흐름을 구성했다.
...
- `rules/*.md`와 `prompts/*.md`를 단계별로 분리했다.
