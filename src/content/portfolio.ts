    ...
    details: [
      ...
      },
      {
        ...
        blocks: [
          ...
          {
            type: "paragraph",
            text: "Typescript를 도입하기로 정한 시점 이후 신규 프로젝트부터는 TypeScript와 Vite를 기반으로 작업했습니다.",
          },
          {
            type: "paragraph",
...
export const aboutParagraphs = [
  ...
  "현재 회사에서는 GIS 대시보드, 솔루션, 데스크톱 애플리케이션, 랜딩 페이지 등의 프론트엔드 작업을 담당했습니다.",
